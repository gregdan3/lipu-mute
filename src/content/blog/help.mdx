---
title: Help!
author: mun Kekan San
description: How do I use ilo Muni?!
date: 2024-08-10
updated: 2026-04-03
published: true
---
...
- **inner**: Count only terms inside the sentence, neither at the start nor end:
  [**nasa_inner**](/?query=nasa_inner)
- **full**: Count only terms that are the entire sentence, at both the start and
  end: [**toki_full**](/?query=toki_full)
...
On the search page, the first dropdown (defaulting to "Relative") offers many
different scales you can graph the data on.
...
On the search page, the second dropdown (defaulting to "Hits") gives you access
to different types of data to graph.
...
1. **What percentage of all words are in this term?**
...
1. **What percentage of all words are any word in this phrase?**
